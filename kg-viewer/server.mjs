...
// Bounded entity vocabulary — Mem0 gateway-one/gateway-two/hermes stacks emit only
// these (15 types + the special internal `__User__`). System_Alpha/Sam are unbounded
...
server.listen(PORT, "0.0.0.0", async () => {
  ...
  log(`Tailscale: http://host-b.your-tailnet.ts.net:${PORT}`);
