...
def run_sync() -> dict[str, Any]:
    """Run full ETL pipeline: MSAM + Project_Two + Git -> Neo4j."""
    start = time.time()
    stats = {
        "entities": 0,
        "atoms": 0,
