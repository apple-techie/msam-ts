 ...
 * 2. Alias resolution (Drew -> Andrew_Peltekci, user -> Andrew_Peltekci)
...
const BUILTIN_ALIASES: Record<string, string> = {
  // Andrew Peltekci
  Andrew: "Andrew_Peltekci",
  andrew: "Andrew_Peltekci",
  Drew: "Andrew_Peltekci",
  drew: "Andrew_Peltekci",
  User: "Andrew_Peltekci",
  user: "Andrew_Peltekci",
  apple_techie: "Andrew_Peltekci",
  "apple-techie": "Andrew_Peltekci",
  "@apple_techie": "Andrew_Peltekci",
  "@MrPeltekci": "Andrew_Peltekci",
  MrPeltekci: "Andrew_Peltekci",
  Mr_Peltekci: "Andrew_Peltekci",
  ...
  enduru: "Enduru",
  Enduru_AI: "Enduru",
  "enduru-kainotomic": "Enduru_Kainotomic",
  Justin: "Justin",
  justin: "Justin",
  Sam: "Sam",
  sam: "Sam",
  ...
  // Projects
  Kainotomic: "Kainotomic",
  kainotomic: "Kainotomic",
  Kainotomic_Inc: "Kainotomic",
  HYDRA: "HYDRA",
  Hydra: "HYDRA",
  hydra: "HYDRA",
  "hydra-trading": "HYDRA",
  MV: "MV_Jewelry_Exchange",
  MV_Jewelry: "MV_Jewelry_Exchange",
  ClipStack: "Clipstack",
  ...
  "vm-1": "VM_1",
  Token_Discovery: "Discovery_Engine",
  TokenDiscovery: "Discovery_Engine",
  "discovery engine": "Discovery_Engine",
  "token discovery": "Discovery_Engine",
};
...
function cleanArtifacts(entity: string): string {
  ...
  // Remove numbered list prefix: "1._(Drew" -> "Drew"
